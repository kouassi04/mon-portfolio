...
class Profile(models.Model):
    ...
    # MODIFIÉ : ImageField -> URLField
    photo = models.URLField(max_length=500, blank=True, null=True) 
    description = models.TextField()
    age = models.IntegerField()
    email = models.EmailField()
    telephone = models.CharField(max_length=20)
    # MODIFIÉ : FileField -> URLField (pour ton CV sur Google Drive ou Dropbox)
    lien_cv = models.URLField(max_length=500, blank=True, null=True)
...
class Testimonial(models.Model):
    ...
    # MODIFIÉ : ImageField -> URLField
    photo_client = models.URLField(max_length=500, blank=True, null=True)
